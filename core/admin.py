...
class OrderAdmin(admin.ModelAdmin):
    list_display = ['user', 'is_ordered', 'is_delivered', 'is_received', 'refund_requested', 'refund_granted','user','billing_address', 'shipping_address', 'payment', 'coupon']
    list_display_link = ['user','billing_address', 'shipping_address', 'payment', 'coupon']
    list_filter = ['user', 'is_ordered', 'is_delivered', 'is_received', 'refund_requested', 'refund_granted']
